<div id="readme-body">
    ...
    <a href="<?php echo Yii::app()->createUrl('readme/reschool'); ?>" id="reschool-1" class="reschool-inner"></a>
    <a href="<?php echo Yii::app()->createUrl('readme/reschool'); ?>" id="reschool-2" class="reschool-inner"></a>
    <a href="<?php echo Yii::app()->createUrl('readme/reschool'); ?>" id="reschool-3" class="reschool-inner"></a>
    <a href="<?php echo Yii::app()->createUrl('readme/reschool'); ?>" id="reschool-4" class="reschool-inner"></a>
    
    <a href="<?php echo Yii::app()->createUrl('readme/notice'); ?>" id="notice-1" class="notice-inner"></a>

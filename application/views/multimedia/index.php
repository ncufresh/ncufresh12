...
<div class="sidebar">
    ...
    <div class="menu">
        ...
        <div id="items1" class="items">
            <a href="#kAAaaW6t-1o" title="炸彈耶驚魂">炸彈耶驚魂</a>
            <a href="#P4gAWD4RCGY" title="現在開始">現在開始</a>
            ...
            <a href="#j9-zvnloDmY" title="練習曲part1">練習曲part1</a>
            <a href="#reY8fVwDNg8" title="練習曲part2">練習曲part2</a>
            <a href="#4wWwrdVN0Fs" title="愛。舞動part1">愛。舞動part1</a>
            <a href="#qLMCzQcW_RE" title="愛。舞動part2">愛。舞動part2</a>
        </div>
...
<div class="content">
    <div class="player">
        ...
        <iframe id="multimedia-frame" name="videoframe" width="100%" height="100%" src="about:blank" frameborder="0" allowfullscreen></iframe>
    </div>
    <div class="introduction">我是介紹文字！</div>
</div>
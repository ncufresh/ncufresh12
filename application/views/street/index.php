...
//-------------------------------------------------------------------------------------------------
    ...
    [
        ...
        { // 25 (行政大樓)            
            ...
            S:{ photo: 'Day 1 (80).jpg', nextPoint: 24 },    
        ...
        { // 28 (品好9舍)            
            N:{ photo: 'Day 3 (67).jpg', nextPoint: (-1) },       
            E:{ photo: 'Day 3 (66).jpg', nextPoint: 27 },    
        ...
        { // 47 (網球場)            
            ...
            S:{ photo: 'Day 3 (14).jpg', nextPoint: (-1) },    
            W:{ photo: 'Day 3 (13).jpg', nextPoint: 48 }
        },
        { // 48 (游泳池)            

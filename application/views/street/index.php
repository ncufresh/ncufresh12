...
<div id="street-div">    
    <div id="back-div">
        ...
        <img id="yun-step" class="landscape picture" show="landscape" href="#23" src="<?php echo Yii::app()->baseUrl?>/statics/building/landscape/mouseleave/yun-step.png">       
        <img id="flower-brook" class="landscape picture" show="landscape" href="#24" src="<?php echo Yii::app()->baseUrl?>/statics/building/landscape/mouseleave/flower-brook.png">
        <img id="big-tree" class="landscape picture" show="landscape" href="#25" src="<?php echo Yii::app()->baseUrl?>/statics/building/landscape/mouseleave/big-tree.png">
        <img id="calligraphy" class="landscape picture" show="landscape" href="#26" src="<?php echo Yii::app()->baseUrl?>/statics/building/landscape/mouseleave/calligraphy.png">
        ...
        <img id="history-gallery" class="government picture" show="government" href="#36" src="<?php echo Yii::app()->baseUrl?>/statics/building/government/mouseleave/history-gallery.png">

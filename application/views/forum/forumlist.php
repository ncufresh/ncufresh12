...
<div id="forum-lists">
    <div class="forum-list-1">
        ...
        <a href="<?php echo Yii::app()->createUrl('forum/forum', array('fid' => 4, 'sort' => 'create'));?>">英美語文學系</a><br/>
        <a href="<?php echo Yii::app()->createUrl('forum/forum', array('fid' => 5, 'sort' => 'create'));?>">法國文學系</a>
    </div>
    <div class="forum-list-2">
        <a href="<?php echo Yii::app()->createUrl('forum/forum', array('fid' => 6, 'sort' => 'create'));?>">土木工程學系</a><br/>
        <a href="<?php echo Yii::app()->createUrl('forum/forum', array('fid' => 7, 'sort' => 'create'));?>">機械工程學系</a><br/>
    ...
    <div class="forum-list-5">
        ...
        <a href="<?php echo Yii::app()->createUrl('forum/forum', array('fid' => 19, 'sort' => 'create'));?>">企業管理學系</a><br/>
        <a href="<?php echo Yii::app()->createUrl('forum/forum', array('fid' => 20, 'sort' => 'create'));?>">資訊管理學系</a><br/>
        <a href="<?php echo Yii::app()->createUrl('forum/forum', array('fid' => 21, 'sort' => 'create'));?>">財務金融學系</a><br/>
    </div>
    <div class="forum-list-6">
        <a href="<?php echo Yii::app()->createUrl('forum/forum', array('fid' => 22, 'sort' => 'create'));?>">地球科學系</a><br/>
        <a href="<?php echo Yii::app()->createUrl('forum/forum', array('fid' => 23, 'sort' => 'create'));?>">大氣科學系</a>
    </div>
</div>
</div>
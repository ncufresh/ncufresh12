...
<?php if ( $profilefir->picture !='' ):?>
        <img  width="40" height="35" src=" <?php echo $target.'/'.$profilefir->picture; ?>" alt="Score image" />
<?php echo $profilefir->name; ?>
<?php else: ?>
        <img  width="40" height="35" src=" <?php echo $target.'/image1.jpg'; ?>" alt="Score image" />
<?php echo $profilefir->name; ?>
<?php endif; ?>     
<?php $account++;?>
<?php endif; ?>
...
<?php if ( $profilethir->picture !='' ):?>
        <img  width="40" height="35" src=" <?php echo $target.'/'.$profilethir->picture ; ?>" alt="Score image"/>
...
<?php if ( $friend->profile->picture !='' ) : ?>
        <img width="40" height="35" src=" <?php echo $target.'/'.$friend->profile->picture; ?>" alt="Score image"/>
